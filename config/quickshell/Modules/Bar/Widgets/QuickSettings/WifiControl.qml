...
RowLayout {
    ...
    function toggle() {
        ...
        wifiNotifyProc.command = ["notify-send", "-a", "System", "-i", root.isActive ? "network-wireless-disconnected" : "network-wireless-connected", "Wi-Fi", root.isActive ? "Disabled" : "Enabled", "-t", "1500"];
